...
from .models import LED_bulb, Customer, Fingerprint_device, Mappingstation,Wallet
...
from .serializers import LED_bulbSerializer, CustomerSerializer, Fingerprint_deviceSerializer, MappingstationSerializer, CustomerSerializer_status, WalletSerializer
